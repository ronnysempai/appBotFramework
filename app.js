...
bot.dialog('rootMenu', [
    ...
    function (session, results){
        ...
        var data = { method: "sendMessage", parameters: { text: "<h1>Informe</h1> <p>Contenido</p> ", parse_mode: "HTML", reply_markup: { keyboard: [ [ { text: "Comparta su Ubicacion", request_location: true } ],[ { text: "Comparta su Contacto", request_contact: true } ] ] } } };
